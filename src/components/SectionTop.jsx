  ...
  return (
    <section className="flex flex-col items-center gap-5 text-center my-20">
      <img
        src={avatar}
        alt="avatar"
        className="rounded-full w-32 h-32 md:w-48 md:h-48" // Ajuste de tamanho responsivo
      />
      <h2 className="leading-[0.9] text-4xl text-slate-800 font-bold">
        Olá, Me Chamo Fernando 👋
      </h2>
      <h1 className="uppercase text-5xl md:text-9xl leading-[0.9] font-bold text-slate-400">
        front-end
        <br />
        Web Developer.
      </h1>
      <p className="text-[1.25rem] text-slate-600 chil max-w-[70rem] px-4 sm:px-8">
        Desenvolvedor{" "}
      ...
      <Button
        className="w-[10rem] h-[3rem] mt-4" // Ajuste de altura
        onClick={() =>
